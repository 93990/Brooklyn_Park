...
const QualityLogin = () => {
  ...
  const demoUsers = [
    { username: 'quality1', password: 'pass123', name: 'John Smith', role: 'Quality Inspector' },
    { username: 'quality2', password: 'pass123', name: 'Sarah Johnson', role: 'Quality Manager' },
    { username: 'admin', password: 'admin123', name: 'Admin User', role: 'Quality Administrator' },
  ];
  ...
  const handleLogin = () => {
    ...
    if (user) {
      // Store user info in localStorage for the quality interface
      localStorage.setItem('qualityUser', JSON.stringify({
    ...
    <Box sx={{ 
      ...
      <AppBar position="fixed" sx={{ 
        ...
        <Container maxWidth="xl" disableGutters>
          <Toolbar sx={{ 
            ...
            {/* Center Section - Quality Login Title */}
            <Box sx={{ 
              display: 'flex',
              alignItems: 'center',
              position: 'absolute',
              ...
              <Box sx={{
                ...
                <SecurityIcon sx={{ color: '#1a365d', mr: 1, fontSize: '1.2rem' }} />
            ...
            <Paper sx={{
              ...
              <Fade in={loaded} timeout={1800}>
                <Box sx={{ 
                  mt: 4, 
                  p: 3, 
                  background: 'linear-gradient(135deg, rgba(26, 54, 93, 0.05), rgba(45, 127, 249, 0.05))', 
                  borderRadius: 3,
                  ...
                  '&::before': {
                    ...
                    right: 0,
                    height: '2px',
                    background: 'linear-gradient(90deg, #1a365d, #2d7ff9, #1a365d)'
                  }
                }}>
      ...
      <Box component="footer" sx={{
        ...
        <Container maxWidth="xl" disableGutters sx={{ 
          ...
          <Typography variant="body2" color="text.secondary">
            {new Date().getFullYear()} Brooklyne Park CAT - Quality Control System
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Chip 
              label="Secure" 
